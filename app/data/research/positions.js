...
const positions = [
  ...
  },
  {
    ...
    abstract: 'The use of employee perks is becoming increasingly important to organizational competitiveness as firms are experiencing recruiting difficulty. Typically, firms introduce perks to attract workers to stay at the workplace. However, another set of perks that makes it easier for people to leave the workplace has gain more popularity over time. These perks, exemplified by unlimited vacation, attract talent, but can also be “dicey,” presenting costs and risks to firms when abused by workers. Motivated by a content analysis of qualitative benefits reviews about unlimited vacation, I establish a theoretical model to predict how heterogeneous workers respond to the perk and when firms should adopt it. I test the predictions via a randomized controlled experiment with an online labor market by recruiting workers to a one-month job. I find that unlimited vacation can offer strategic benefits to firms in three major ways: (1) attracting the more capable candidates to the recruitment pool, (2) creating complementarity to work that makes people more productive, and (3) inducing extra work outputs from happier workers. Furthermore, a strong firing threat under unlimited vacation reduces the likelihood of slacking and nudges workers to produce more. Finally, workers under unlimited vacation on average take more vacation time than their counterparts under capped vacation.'
  }
  //, 
];
